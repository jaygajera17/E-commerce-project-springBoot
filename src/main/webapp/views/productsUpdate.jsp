...
<head>
    ...
    <title>Update Product – ShopEase Admin</title>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        ...
        .form-card {
            background: #161628; border: 1px solid rgba(245,158,11,0.12);
        ...
        .form-floating textarea.form-control {
            background: #0d0d1a; border: 1.5px solid #2a2a3a;
        ...
        .form-floating textarea.form-control:focus {
            background: #0d0d1a; border-color: #f59e0b;
            box-shadow: 0 0 0 3px rgba(245,158,11,0.18); color: #fff;
        }
        ...
        .btn-submit:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(245,158,11,0.45); color: #fff; }
        .btn-back {
        ...
        .file-input-styled { background: #0d0d1a; border: 1.5px solid #2a2a3a; border-radius: 10px; color: #9999bb; }
        .file-input-styled::-webkit-file-upload-button {
            background: rgba(245,158,11,0.15); border: none; border-radius: 8px;
            color: #fbbf24; padding: 6px 14px; font-weight: 600; cursor: pointer;
        }
...
<div class="page-header">
    <div class="container">
        <h2><i class="fas fa-pen-to-square me-2"></i>Update Product</h2>
    </div>
</div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" name="price" id="price" class="form-control"
                               placeholder="Price" value="${product.price}" min="1" required>
                        <label for="price"><i class="fas fa-dollar-sign me-1"></i>Price ($)</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="number" name="weight" id="weight" class="form-control"
                               placeholder="Weight" value="${product.weight}" min="1" required>
                        <label for="weight"><i class="fas fa-weight-hanging me-1"></i>Weight (grams)</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="number" name="quantity" id="quantity" class="form-control"
                               placeholder="Quantity" value="${product.quantity}" min="1" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-floating mb-3">
                        <textarea name="description" id="description" class="form-control"
                                  placeholder="Description" style="height:120px">${product.description}</textarea>
                        <label for="description">Product Description</label>
                    </div>

                    <label class="mb-2" style="color:#7777aa;font-size:0.85rem">Update Product Image</label>
                    <input type="file" name="productImage" id="productImageFile"
                           class="form-control file-input-styled mb-2"
                           accept="image/jpeg, image/png"
                           onchange="previewFile(event)">

                    <div class="img-preview-box">
                        <img id="imgPreview" src="${product.image}" alt="Current product image">
                    </div>
                    <input type="hidden" name="imgName">
                </div>
            </div>

            <hr style="border-color:rgba(245,158,11,0.1); margin:28px 0">
