...
<head>
    ...
    <style>
        ...
        .error-msg { color: #ef4444; font-size: 0.875rem; text-align: center; margin-bottom: 12px; }
    </style>
</head>
<body>
...
<div class="auth-card">
    ...
    <form action="/newuserregister" method="post">
        ...
        <div class="form-floating mb-3">
            ...
            <label for="address"><i class="fas fa-location-dot text-muted me-2"></i>Delivery Address</label>
        </div>
